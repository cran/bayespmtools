# bpm_modelrevisionvoi <- function(
#   N,
#   sample,
#   threshold,
#   method = c("int", "int+slp")[2],
#   ex_args = NULL
# ) {
#   out <- list(N = N)
#
...
#       this_row <- sample[j, ]
#       p <- do.call(
#         paste0("r", this_row$dist_type),
#         as.list(unname(c(n, this_row$dist_parm1, this_row$dist_parm2)))
#       )
...
#       this_row$cal_int <- this_row$cal_int -
#         (this_row$cal_slp / est_cal_slp) * est_cal_int
#       this_row$cal_slp <- this_row$cal_slp / est_cal_slp
#
#       updated_se_sp <- calc_se_sp(
#         this_row$dist_type,
